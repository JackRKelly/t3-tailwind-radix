...
)`w-full rounded-lg px-4 py-2 flex items-center justify-center text-sm font-medium bg-primary-bold text-white hover:bg-primary focus:z-10 focus:outline-none focus-visible:ring focus-visible:ring-highlight focus-visible:ring-opacity-50`;

const Close = tw(
	ToastPrimitive.Close
)`w-full border border-primitive-edge focus-visible:border-transparent rounded-lg px-4 py-2 flex items-center justify-center text-sm font-medium text-primitive-type hover:bg-primitive focus:z-10 focus:outline-none focus-visible:ring focus-visible:ring-highlight focus-visible:ring-opacity-50`;
