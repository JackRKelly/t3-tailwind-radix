		...
		<DialogPrimitive.Root open={isOpen} onOpenChange={setIsOpen}>
			...
			<Transition.Root show={isOpen}>
				...
				>
					...
					>
						<DialogPrimitive.Title className="text-sm font-medium text-primitive-type-bold dark:text-gray-100">
							Edit profile
						</DialogPrimitive.Title>
						<DialogPrimitive.Description className="mt-2 text-sm font-normal text-primitive-type dark:text-gray-400">
						...
						<form className="mt-2 space-y-2">
							<fieldset>
								...
								<label
									htmlFor="firstName"
									className="text-xs font-medium text-primitive-type dark:text-gray-400"
								>
									First Name
								</label>
								<input
									...
									className={cx(
										...
										"text-sm text-primitive-type placeholder:text-gray-500 dark:text-gray-400 dark:placeholder:text-gray-600",
