...
const Tabs = (props: Props) => {
	return (
		<TabsPrimitive.Root defaultValue="tab1">
			<TabsPrimitive.List className={cx("flex w-full rounded-t-lg bg-primitive dark:bg-gray-800")}>
			...
			{tabs.map(({ value }) => (
				<TabsPrimitive.Content
					...
					value={value}
					className={cx("rounded-b-lg bg-primitive px-6 py-4 dark:bg-gray-800")}
				>
