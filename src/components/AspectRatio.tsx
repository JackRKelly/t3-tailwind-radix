		...
		<Fragment>
			...
			>
				<div className="absolute inset-0 z-10 flex items-center justify-center">
					<h3 className="select-none bg-gradient-to-r from-primary to-secondary bg-clip-text text-3xl font-black uppercase text-transparent duration-300 ease-in-out group-hover:opacity-0 sm:text-4xl">
						Vancouver
					</h3>
				</div>
				<div
					className={cx(
						"absolute inset-0 bg-slate-800 object-cover group-hover:bg-primitive-faint0",
