		...
		<CollapsiblePrimitive.Root open={isOpen} onOpenChange={setIsOpen}>
			<CollapsiblePrimitive.Trigger
				className={cx(
					...
					"bg-primitive text-gray-900 dark:bg-gray-800 dark:text-gray-100",
				...
				{["80s Synthwave", "Maximale Konzentration", "高人氣金曲"].map((title, i) => (
					<div
						...
						className={cx(
							...
							"bg-primitive text-gray-900 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-900"
						)}
					>
						{title}
